...
💡 Please refer to our [documentation](https://docs.scanbot.io/android/barcode-scanner-sdk/scan-result-handling/data-parsers/?utm_source=github.com&utm_medium=referral&utm_campaign=dev_sites) for a full list of supported data parsers.
