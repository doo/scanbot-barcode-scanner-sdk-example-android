...
💡 Please visit our [docs](https://docs.scanbot.io/android/barcode-scanner-sdk/supported-barcodes/?utm_source=github.com&utm_medium=referral&utm_campaign=dev_sites) for a complete overview of the supported barcode symbologies.
...
💡 Please refer to our [documentation](https://docs.scanbot.io/android/barcode-scanner-sdk/supported-barcodes/#data-parsers) for a full list of supported data parsers.
