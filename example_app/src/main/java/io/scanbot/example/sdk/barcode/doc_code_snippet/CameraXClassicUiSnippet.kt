...
class CameraXCustomUiSnippetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // @Tag("Barcode Custom UI orientation lock snippet")
        ...
        // @EndTag("Barcode Custom UI orientation lock snippet")

        // @Tag("Barcode Custom UI configure shutter sound snippet")
        cameraView.setCameraOpenCallback {
            cameraView.postDelayed({
                cameraView.setShutterSound(false)
            }, 700)
        }
        // @EndTag("Barcode Custom UI configure shutter sound snippet")

        // @Tag("Barcode Custom UI configure focusing snippet")
        cameraView.setCameraOpenCallback {
            cameraView.postDelayed({
                cameraView.continuousFocus()
            }, 700)
        }
        // @EndTag("Barcode Custom UI configure focusing snippet")
    }
}
